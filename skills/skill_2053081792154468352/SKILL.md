...
1. Always use `browser-use` CLI commands — never fabricate URLs, page titles, or element text
2. Never generate Chrome extension, Tampermonkey, Selenium, or Puppeteer code as a substitute
3. After every interaction, verify the result with `browser-use state` or `browser-use screenshot`
